...
], function (declare, lang, Extent, SpatialReference, TileInfo, BaseTileLayer) {
    return BaseTileLayer.createSubclass({
        ...
        constructor: function (args) {
            ...
            this.tileInfo = new TileInfo({
                ...
                origin: {
                    x: -20037508.3427892-535,
                    y: 20037508.3427892+395
                },
        ...
        getTileUrl: function (level, row, col) {
            ...
            return 'http://tm.amap.com/trafficengine/mapabc/traffictile?v=1.0&;t=1&x=' + col + '&y=' + row + '&z=' + level + '&t=' + longTime + '';
        }
    });
});
